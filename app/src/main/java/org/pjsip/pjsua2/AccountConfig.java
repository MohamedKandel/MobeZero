...
public class AccountConfig extends PersistentObject {
  ...
  public void SetSipKey(int sipenable, String key, int keylength) {
    pjsua2JNI.AccountConfig_SetSipKey(swigCPtr, this, sipenable, key, keylength);
  }

  public void RtpSipKey(int rtpenable, String rtpkey, int rtpkeylength, int padenable, int dtop, int ptod) {
    pjsua2JNI.AccountConfig_RtpSipKey(swigCPtr, this, rtpenable, rtpkey, rtpkeylength, padenable, dtop, ptod);
  }
