...
//		{
//			String acc_id =  "1122<sip:1122@69.30.193.84:3939>";
//		    //String acc_id 	 = etId.getText().toString();
//		    String registrar = "sip:69.30.193.84:3939";//etReg.getText().toString();
//		    String proxy 	 = "185.99.253.190:443";//etProxy.getText().toString();
//		    String username  = "1122";//etUser.getText().toString();
//		    String password  = "223355";//etPass.getText().toString();
//
//			proxy 	 = "sip:"+proxy+";lr;transport=udp";
//
...
//		    }
//
//			accCfg.SetSipKey(1, "YKWtAUr0D8MIc@3p#CnNXdil6x", 26);
//			accCfg.RtpSipKey(1, "YKWtAUr0D8MIc@3p#CnNXdil6x", 26, 1, 1, 1);
//
//		    /* Enable ICE */
